...
export async function POST(request: Request) {
  try {
    ...
    const prompt = `Analyze the following ${language || ''} code and respond strictly as JSON with the following fields only:\n{
  ...
  "optimizationPercent": 0
    ...
    try {
      ...
      return NextResponse.json({
        ...
        optimizationPercent: typeof parsed.optimizationPercent === 'number' ? parsed.optimizationPercent : undefined,
      });
    } catch (e) {
